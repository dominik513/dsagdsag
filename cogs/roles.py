...
class RolesShop(commands.Cog):
    ...
    @discord.slash_command(name="add_shop_role", description="Добавить роль в магазин")
    ...
    @discord.slash_command(name="add_shop_dota_plus", description="Добавить Dota Plus в магазин")
    @commands.has_permissions(administrator=True)
    ...
    @discord.slash_command(name="add_shop_item", description="Добавить предмет в магазин")
    @commands.has_permissions(administrator=True)
    ...
    @discord.slash_command(name="remove_shop_item", description="Убрать товар из магазина")
    @commands.has_permissions(administrator=True)
    ...
    @discord.slash_command(name="points_add", description="Выдать очки игроку")
    @commands.has_permissions(administrator=True)
    ...
    @discord.slash_command(name="points_take", description="Списать очки у игрока")
    @commands.has_permissions(administrator=True)
    ...
    @discord.slash_command(name="points_set", description="Установить точное число очков игроку")
    @commands.has_permissions(administrator=True)
